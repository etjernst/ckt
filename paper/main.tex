...
We nonetheless verify empirically that the baseline estimates do not depend on partial observers by re-estimating the restricted GRC on the balanced subsample.
