...
Relative to those exercises, our contribution is a partial-equilibrium consumption-side magnitude disciplined by GRC-identified objects, with a trajectory-level decomposition that the existing literature does not deliver.
