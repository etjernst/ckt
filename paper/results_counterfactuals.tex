...
We also report a decomposition of the gap into the contribution of never-migrants ($d_N$), switchers, and always-urban workers ($d_T$).
This decomposition by panel trajectory is what the existing aggregate-gain literature does not deliver: under our pro-poor finding the never-migrant piece dominates the aggregate, and isolating where the misallocation lives is the cleanest way to communicate the substantive content of the magnitude.
