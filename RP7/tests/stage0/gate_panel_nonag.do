* *******************************************************************
* Title:   Gate-panel slice of 5_GrRC_NonAg.do (Stage 0 baseline)
* Author:  Emilia Tjernstrom
* Date:    2026-07-15
* Purpose: IDN non-ag GRC cell, c1/c2/ca specs only (_ct column dropped).
...
* set log file
capture log close
log using "$logs/gate_panel_nonag.log", replace
