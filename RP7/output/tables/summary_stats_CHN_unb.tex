\begin{table}[htbp] \centering \caption{Summary Statistics China}\label{tab:summary_stats_CHN_unb} \begin{threeparttable} \begin{tabular}{l cccc} \toprule
 &  &  &  & $t$-test \\
\midrule
...
Individuals & 34,746 &  &  &  \\
Non-switchers &   37.6\% &  &  &  \\  \addlinespace
