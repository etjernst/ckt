...
* Run program to create multi-panel table
	create_panel_tex_table, panels(3) columns(7) 						///
...
* **********************************************************************
* 4. Income | Urban | Unbalanced | OLS & FE
* **********************************************************************
eststo clear			
* Choices
	local choice 		urban
...
* Table caption	
	local table_caption "`" \caption{OLS Estimates of the Returns to Urban Location on log Income} "'"
* Table label
	local table_label "`" \label{tab:OLS_`depvar'_`choice'_`balance'} "'" 	
* Table notes
