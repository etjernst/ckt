...
* ************
* Experience control
run_grc, estname(grc_`country'_maxexpsh_c1)                             ///
...
* Add female
run_grc, estname(grc_`country'_maxexpsh_c2)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
* Add age2
run_grc, estname(grc_`country'_maxexpsh_c3)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
run_grc, estname(grc_`country'_maxexpsh_ca)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
foreach country in IDN CHN TZA {
    foreach estname in c1 c2 c3 ca {
        estimates use "$dir/output/grc_`country'_maxexpsh_`estname'"
        estimates store grc_`country'_maxexpsh_`estname'
        estimates use "$dir/output/grc_`country'_maxexpsh_`estname'_never"
        estimates store grc_`country'_maxexpsh_`estname'_never
        estimates use "$dir/output/grc_`country'_maxexpsh_`estname'_avg"
        estimates store grc_`country'_maxexpsh_`estname'_avg
    }
    }
...
estimates table                                       ///
    grc_`country'_maxexpsh_c1 grc_`country'_maxexpsh_c2     			  ///
    grc_`country'_maxexpsh_c3 grc_`country'_maxexpsh_ca         		  ///
