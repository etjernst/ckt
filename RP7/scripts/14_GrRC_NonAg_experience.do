...
* ************
* Experience control
run_grc, estname(grc_`country'_cnu_exp_c1)                             ///
...
* Add female
run_grc, estname(grc_`country'_cnu_exp_c2)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
* Add age2
run_grc, estname(grc_`country'_cnu_exp_c3)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
run_grc, estname(grc_`country'_cnu_exp_ca)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
foreach country in IDN {
    foreach estname in c1 c2 c3 ca {
        estimates use "$dir/output/grc_`country'_cnu_exp_`estname'"
        estimates store grc_`country'_cnu_exp_`estname'
        estimates use "$dir/output/grc_`country'_cnu_exp_`estname'_n"
        estimates store grc_`country'_cnu_exp_`estname'_n
        estimates use "$dir/output/grc_`country'_cnu_exp_`estname'_g"
        estimates store grc_`country'_cnu_exp_`estname'_g
    }
    }
...
estimates table                                       ///
    grc_`country'_cnu_exp_c1 grc_`country'_cnu_exp_c2     			  ///
    grc_`country'_cnu_exp_c3 grc_`country'_cnu_exp_ca         		  ///
