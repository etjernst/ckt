...
This code:
    ...
    - covariates (columns): (1) max experience, (2) add time FE, (3) add female, 
...
cd "$logs"
capture log close
log using 11_GrRC_max_experience.log, replace
...
* **********************************************************************
* 1. Consumption | Urban | Unbalanced | GRC | Max Experience
* **********************************************************************
...
* ************
* Experience control
run_grc, estname(grc_`country'_cuu_maxexp_c1)                             ///
...
* Add female
run_grc, estname(grc_`country'_cuu_maxexp_c2)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
* Add age2
run_grc, estname(grc_`country'_cuu_maxexp_c3)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
run_grc, estname(grc_`country'_cuu_maxexp_ca)                             ///
    switchers($switchers) base(`base') initial(`initial') ///
    balance(`balance')                                             ///
...
foreach country in IDN CHN TZA {
    foreach estname in c1 c2 c3 ca {
        estimates use "$dir/output/grc_`country'_cuu_maxexp_`estname'"
        estimates store grc_`country'_cuu_maxexp_`estname'
        estimates use "$dir/output/grc_`country'_cuu_maxexp_`estname'_n"
        estimates store grc_`country'_cuu_maxexp_`estname'_n
        estimates use "$dir/output/grc_`country'_cuu_maxexp_`estname'_g"
        estimates store grc_`country'_cuu_maxexp_`estname'_g
    }
    }
...
estimates table                                       ///
    grc_`country'_cuu_maxexp_c1 grc_`country'_cuu_maxexp_c2     			  ///
    grc_`country'_cuu_maxexp_c3 grc_`country'_cuu_maxexp_ca         		  ///
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Indonesia, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in China, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Tanzania, Max Experience Controls} "'"
...
* **********************************************************************
* 2. Consumption | Urban | Balanced | GRC | Max Experience
* **********************************************************************
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Indonesia, Balanced Panel, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in China, Balanced Panel, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Tanzania, Balanced Panel, Max Experience Controls} "'"
...
* **********************************************************************
* 3. Income | Urban | Unbalanced | GRC | Max Experience
* **********************************************************************
...
* Keep only relevant variables (speeds up estimation)
global keepvars lndepvar $lnsize trajectory choice pid exp_max
global keepvars $keepvars period unbalanced* switcher non_switcher
global keepvars $keepvars female age age2
global keepvars $keepvars education_max education_max2 trend
global keepvars $keepvars always always_choice never switcher_*
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, Indonesia, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, China, Max Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, Tanzania, Max Experience Controls} "'"
