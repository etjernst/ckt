...
cd "$logs"
capture log close
log using 10_GrRC_experience.log, replace
...
* **********************************************************************
* 1. Consumption | Urban | Unbalanced | GRC | Experience
* **********************************************************************
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Indonesia, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in China, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Tanzania, Experience Controls} "'"
...
* **********************************************************************
* 2. Consumption | Urban | Balanced | GRC | Experience
* **********************************************************************
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Indonesia, Balanced Panel, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in China, Balanced Panel, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Consumption in Tanzania, Balanced Panel, Experience Controls} "'"
...
* **********************************************************************
* 3. Income | Urban | Unbalanced | GRC | Experience
* **********************************************************************
...
* Keep only relevant variables (speeds up estimation)
global keepvars lndepvar $lnsize trajectory choice pid exp
global keepvars $keepvars period unbalanced* switcher non_switcher
global keepvars $keepvars female age age2
global keepvars $keepvars education_max education_max2 trend
global keepvars $keepvars always always_choice never switcher_*
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, Indonesia, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, China, Experience Controls} "'"
...
* Table caption
local table_caption "`" \caption{Restricted GRC Estimates of the Returns to Urban Location on log Income, Tanzania, Experience Controls} "'"
